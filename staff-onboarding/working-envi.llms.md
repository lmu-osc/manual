...
For an overview of all technologies used at the OSC, see the [Technology Overview](../tech-overview.llms.md).
...
[Click here for self-paced tutorials on R](https://www.osc.lmu.de/training/self-learning.html#category=R)
...
- [GitHub Manual](../github/index.llms.md)

## Useful GitHub Links

- [Self-paced tutorials on GitHub](https://www.osc.lmu.de/training/self-learning.html#category=GitHub)
- [All OSC Repositories](https://github.com/orgs/lmu-osc/repositories)
- [OSC GitHub Organization](https://github.com/lmu-osc)
- [OSC Website Repository](https://github.com/lmu-osc/lmu-osc.github.io)
...
[Click here to go to the OSC Google Drive](https://drive.google.com/drive/folders/1mGDWgM7ekqP9gZ1u6Q6BlM-wcrZav8gG?usp=drive_link)
...
| **Events** | Contains all documents, forms, sheets, central organizational documents for previous events |
...
- [Work with Assistants Folder](https://drive.google.com/drive/folders/1WxLB_xM4eN8GsSdGrfw6DnW8QqlZ33av)
...
- At the top of the relevant section in the ToDo overview document.
- In the task table.
- As a shortcut in the appropriate Google Drive folder.

# LRZ Sync and Share

[LRZ Sync and Share](https://syncandshare.lrz.de/login) is a secure cloud storage and file-sharing service provided by the Leibniz Supercomputing Centre (LRZ).
...
- Financial records
- OSC accounts credentials (e.g. social media)
