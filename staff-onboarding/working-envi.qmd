...
1. First step is to make a new folder in **your** Google Drive so you have a designated location for the OSC files.
2. For each folder shared with you, create a shortcut to the designated folder in **your** Google Drive.

::: callout-tip
## Making shortcuts in Google Drive
