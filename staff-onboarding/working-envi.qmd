...
For an overview of all technologies used at the OSC, see the [Technology Overview](../tech-overview.qmd).
...
- [GitHub Manual](../github/index.qmd)
...
::: callout-tip
## Should I learn how to do *everything* in Quarto?
...
Staff get access to the full google drive folder while student assistants get given access to some folders only.

[Click here to go to the OSC Google Drive](https://drive.google.com/drive/folders/0B3guf1IgoPEmbzV2YVk3TzMxYW8?resourcekey=0-lWwzvQDw6Hoe9SlbuY1vVA&usp=drive_link)
...
::: {.callout-tip}
## Creating Shortcuts in Google Drive
...
- [LRZ GitLab](../lrz-gitlab/index.qmd)
...
- [Registration](../osc-events/registration.qmd) for detailed information on **pretix**
- [Applications](../osc-events/application.qmd) for detailed information on **formr**
...
- [OSC Newsletter](../osc-outreach/newsletter.qmd)
