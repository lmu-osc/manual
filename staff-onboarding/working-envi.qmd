...
If you are not already familiar with the following programs and platforms, the OSC offers self paced tutorials on some of them: [OSC Tutorials](https://github.com/lmu-osc?view_as=public).
...
For detailed information on how the OSC uses these platforms, see:

- [Registration and OSC Event Pages](../osc-events/registration.qmd)
