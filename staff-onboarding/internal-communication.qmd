...
Once your account is set up, join the OSC workspace using the following invitation link: <https://matrix.to/#/#lmu-open-science-center:matrix.lmu.de>
...
![](/assets/images/01-zoom-schedule.png){width="50"}
