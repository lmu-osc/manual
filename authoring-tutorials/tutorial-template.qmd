---
title: Tutorial Template Walkthrough
subtitle: A thorough overview of the `tutorial-template` repository and Quarto extension — how to navigate it, adapt it, and avoid common pitfalls
---
...
Click through the slides below using the left/right arrow keys, or [open the deck directly](tutorial-template-slides.qmd){target="_blank"} to see it full screen.

<iframe class="slide-deck" src="tutorial-template-slides.html" title="Step-by-step slide deck: adapting the tutorial template"></iframe>
...
::: {.callout-note title="What is not copied"}
...
::: {.callout-warning title="Do not edit the extension by hand"}
...
::: {.callout-tip title="Important conventions for content pages"}
...
::: {.callout-important title="Key things to know about the workflows"}
...
::: {.callout-warning title="Styling: what NOT to do"}
