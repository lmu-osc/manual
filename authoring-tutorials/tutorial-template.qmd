...
subtitle: A thorough overview of the `tutorial-template` repository — how to navigate it, adapt it, and avoid common pitfalls
---
...
::: {.callout-tip}
#### Important conventions for content pages
...
::: {.callout-important}
#### Key things to know about the workflows
...
Change these values:
- `title:` — set to your tutorial's name
