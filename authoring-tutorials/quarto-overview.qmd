...
::: {.callout-tip title="`quarto use template` vs. `quarto add`"}
...
#| eval: true     # Run the code (set to false to show code only)
#| fig-cap: "My plot"
...
The table here is even cross-referencable with `@tbl-filetypes`: @tbl-filetypes. Learn more about [tables in Quarto](https://quarto.org/docs/authoring/tables.html).
