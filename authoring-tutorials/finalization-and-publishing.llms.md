...
Before anything else, make sure you finished the setup steps from the [Tutorial Template Walkthrough](../authoring-tutorials/tutorial-template.llms.md):
...
Once you have completed the checklist above and your tutorial has been approved through the review process and you have run `quarto publish gh-pages`, your tutorial will be live on the OSC website. The URL will follow the pattern: `https://lmu-osc.github.io/<tutorial-name>/`.

However, you should still run some additional checks to ensure everything is working as expected before beginning to advertise your tutorial to the public. See the next section for a final checklist of items to verify before merging your tutorial into the main tutorials repository.
...
2.  **Create a new release** on GitHub — go to your repository’s **Releases** page, click **“Draft a new release”**, set a version tag (e.g., `v0.1.0`), add release notes, and publish
