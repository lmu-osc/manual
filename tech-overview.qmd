---
title: Tech Overview
subtitle: What we use at the OSC
---
...
- **RStudio / Positron** — Our integrated development environment (IDE) for R. We are in the process of transitioning from RStudio to [Positron](https://positron.posit.co/).
- **git** — Version control system for tracking changes in code and content.
- **GitHub** — Platform for hosting repositories, managing contributions, and collaborating via pull requests and issues. See the [GitHub Organization](github/index.qmd) section for more.
- **Pandoc Markdown** — The markup language used across our tutorials and documentation.
- **Quarto** (basic) — Publishing system built on Pandoc that we use for all of our websites and tutorials. See the [Authoring Tutorials](authoring-tutorials/index.qmd) section for details.
...
- **CSS / HTML** — Used for styling and structuring our Quarto websites. See the [Updating Website](updating-website/index.qmd) section for practical examples.
- **Bootstrap** — The underlying CSS framework for our Quarto websites (we use the Cosmo Bootswatch theme).
- **Python** — Used alongside R for various data processing and automation tasks.
- **GitHub Actions** (high-level understanding) — CI/CD pipelines for automating builds, tests, and deployments. See the [GitHub Organization](github/index.qmd) section for more.
...
- **In-depth Quarto** — Advanced configuration, custom formats, Lua filters, and extension development.
