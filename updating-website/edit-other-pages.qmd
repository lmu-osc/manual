...
Detailed instructions for updating important page types such as [Members](create-new-members-page.qmd), [Events](create-event-page.qmd), and [News](create-news-item.qmd) are already provided. This section provides general guidance for editing all other pages on the OSC website.
...
- [GitHub Working Practices](../github/working-practices.qmd)
