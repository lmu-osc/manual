...
When creating on Canva, either get access to OSC’s Canva account (credentials provided by Malika, stored in LRZ SYnc & Share LMU OPen Science Center folder root) or use your own personal account invited to the OSC space. The design created on Canva should remain accessible to the OSC.
...
- [See the powerpoint presentation here in the Google Drive](https://docs.google.com/presentation/d/1V2hSszjld061O1N27GEyjQ9hf_NBI8AP/edit?usp=drive_link&ouid=112987352614073849735&rtpof=true&sd=true) for flyers made and used in the past as well as blank templates for reuse.
- [See here for a flyer about the OSC](https://docs.google.com/presentation/d/188QPtIdl2IjIXbJcthXYj3QCBCJURbqJ/edit?slide=id.p1#slide=id.p1)
