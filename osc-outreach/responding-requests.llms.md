...
Our general rules is to advertise:
...
The advertisement you requested to circulate doesn’t seem to fall in any of these categories. I suggest you request for it to be circulated within e.g. XXX.
...
Becoming an OSC fellow (for LMU researchers without a PhD) follows a different process than applications to becoming an OSC member. They need to contribute an event, co-lead a grassroot initiative, co-instruct or help on the delivery of a course or workshop.
...
Thanks for your volunteer contributions to the goals and efforts of the LMU Open Science Center. You are welcome to become a OSC fellow.
