...
3. Run the command `quarto publish gh-pages` at the terminal, and agree to publish the site.
  ...
  - Note: if your terminal becomes stuck on the message "Deploying gh-pages branch to website (this may take a few minutes)" and if your deployment wasn't successful, then you have probably not made the repository public. Navigate to the Visibility option in your settings, and change to public. Then, repeat the command above.
