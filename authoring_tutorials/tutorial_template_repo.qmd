...
stop <- which(stringr::str_detect(all_lines, "navbar:")) - 1
cat("```yaml", readLines("_quarto.yml")[start:stop], "```", sep = "\n")
```
...
stop <- which(stringr::str_detect(all_lines, "sidebar:")) - 1
cat("```yaml", readLines("_quarto.yml")[start:stop], "```", sep = "\n")
```
