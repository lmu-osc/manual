...
To add the new member to all relevant OSC mailing lists, one needs to be an administrator of those lists. Currently, only Felix and Malika are administrators. To become an adminsitrator, one first need to create an account at https://doku.lrz.de/mailman-3-2281340989.html?showLanguage=en_GB.

### Current mailing lists a member may need to be added to

| Name (info page) | Email | Description | Subscription & Posting |
|----|----|----|----|
| [LMU Open Science Center News](https://lists.lrz.de/mailman3/lists/lmu-osc.lists.lrz.de/) | <lmu-osc@lists.lrz.de> | Our public community mailing list. | Anyone can subscribe. Only Malika and Felix can post. |
| [Members](https://lists.lrz.de/mailman3/lists/lmu-osc-members.lists.lrz.de/) | <lmu-osc-members@lists.lrz.de> | For officially onboarded OSC members with a doctoral degree or professorship. Used to announce internal matters. | Only an administrator can add subscribers. Any subscriber can post. |
...
| [Scientific Board](https://lists.lrz.de/mailman3/lists/lmu-osc-board.lists.lrz.de/) | <lmu-osc-board@lists.lrz.de> | For members of the OSC Scientific Board (elected every two years). | Only an administrator can add subscribers. Any subscriber can post. |
| [Munich Carpentries Instructors](https://lists.lrz.de/mailman3/lists/carpentries-instructors.lists.lrz.de/) | <carpentries-instructors@lists.lrz.de> | For certified instructors and helpers who teach computing skills using live coding. | Only an administrator can add subscribers. Any subscriber can post. |
...
Best wishes Malika, OSC coordinator
