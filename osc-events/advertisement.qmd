...
<!--TODO Beth/Sarah/ a table / sheet in LRZ Sync & Share?-->
...
- [ ] Advertise the event through relevant channels, e.g.:
  ...
  - [ ] Send notification to Karabulut Seyhan <Seyhan.Karabulut@Verwaltung.Uni-Muenchen.DE>  working for Riesche Barbara <Barbara.Riesche@Verwaltung.Uni-Muenchen.DE> if relevant for post doc across several disciplines to get on Excellerate website <!-- remove emails of individuals on our public website -->
