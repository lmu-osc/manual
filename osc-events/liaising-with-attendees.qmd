...
Find detailed instructions here: [Registration](registration.qmd) and [Applications](application.qmd)
...
- [ ] Confirm attendance for large events with application (e.g. OSS):
...
See this section for more information: [Wrap Up and and Feedback](wrapup-feedback.qmd)
