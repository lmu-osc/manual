...
Cable to charge the table microphone during use (if venue is Philologikum library which comes with table microphones)
...
- [Barco ClickShare Extension Pack](https://www.barco.com/na-en/product/clickshare-extension-pack) to allow extended screen with the Click-and-Share device
...
Red and green sticker notes

Suitcase for transporting equipment

Large backpack for snacks

External battery if need electricity without power outlet
...
A Carpentry workshop is a hands-on computing skills training using live coding as a mode of teaching.

For a detailed step-by-step guide on planning and organizing a carpentry workshop, consult and make a copy of the dedicated Carpentry workshop checklist to prepare your own workshop:
...
The complete Carpentry folder, containing additional resources, lists of available instructor and backgrounds, and documentation from previous Carpentry workshops, can be found here:
...
Each year, we create a folder based on the previous year’s summer school (e.g. [OSSS26 folder](https://drive.google.com/drive/folders/1LuXEtEtUHbPJ93jmR5x1atSUouH7tpCm)): update all forms and tempplates for everything. We have one organizational Gdoc with several tabs (e.g. [OSSS26](https://docs.google.com/document/d/1Yw2l7OfeoPa3-tM_jPdSxfHgp54ko-ZkKdaIJ0hSc0I/edit?tab=t.0)) going through all subchapter of this Event chapter, with templates for everything (forms, emails, checklists).
