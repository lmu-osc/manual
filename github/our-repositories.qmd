...
For the conventions that apply to every repository --- visibility, creating a new one, access and roles, and retiring one --- see [Repositories](/github/lmu-osc-organization/repositories.qmd).
...
For detailed information on the deployment pipeline, see the [Main Website Deployment Details](/misc-topics/main-website-deployment.qmd) page.
